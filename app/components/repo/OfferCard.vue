...
import { getTokensConfig, getTokenByAddress } from "~/config/tokens";
...
// Token configs
const lendTokenConfig = computed(() => getTokenByAddress(props.offer.lendToken, tokens));
const collateralTokenConfig = computed(() => getTokenByAddress(props.offer.collateralToken, tokens));

// User identity checks
const isLenderUser = computed(() =>
  props.userAddress && props.offer.lender.toLowerCase() === props.userAddress.toLowerCase(),
);
const isBorrowerUser = computed(() =>
  props.userAddress && props.offer.borrower && props.offer.borrower.toLowerCase() === props.userAddress.toLowerCase(),
);
