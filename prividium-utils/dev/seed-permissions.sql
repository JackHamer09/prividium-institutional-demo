-- Seed script for prividium_api database (single-chain)
-- Seeds contract templates, contracts, permissions, and user wallet data
-- Run with: docker exec -i <postgres-container> psql -U postgres -d prividium_api < prividium-utils/dev/seed-permissions.sql
...
-- ============================================================================
-- 5. Contract Function Permissions (Repo contract + Native Token Vault)
-- ============================================================================
INSERT INTO contract_function_permissions (id, contract_address, method_selector, function_signature, rule_type, access_type)
OVERRIDING SYSTEM VALUE
VALUES
    -- RepoContract functions (single-chain, no interop fields)
    (1, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('c815729d', 'hex'), 'function acceptOffer(uint256 _offerId)', 'public', 'write'),
    ...
    (6, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('42cbb4b8', 'hex'), 'function createOffer(address _lendToken, uint256 _lendAmount, address _collateralToken, uint256 _collateralAmount, uint256 _duration, uint256 _lenderFee) returns (uint256 offerId)', 'public', 'write'),
    (7, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('c6985330', 'hex'), 'function getBorrowerOffers(address _user) view returns ((uint256 offerId, address lender, address borrower, address lendToken, uint256 lendAmount, address collateralToken, uint256 collateralAmount, uint256 duration, uint256 startTime, uint256 endTime, uint256 lenderFee, uint8 status)[])', 'public', 'read'),
    (8, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('c9fdfcce', 'hex'), 'function getLenderOffers(address _user) view returns ((uint256 offerId, address lender, address borrower, address lendToken, uint256 lendAmount, address collateralToken, uint256 collateralAmount, uint256 duration, uint256 startTime, uint256 endTime, uint256 lenderFee, uint8 status)[])', 'public', 'read'),
    (9, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('d2024b1e', 'hex'), 'function getOpenOffers() view returns ((uint256 offerId, address lender, address borrower, address lendToken, uint256 lendAmount, address collateralToken, uint256 collateralAmount, uint256 duration, uint256 startTime, uint256 endTime, uint256 lenderFee, uint8 status)[])', 'public', 'read'),
    ...
    (12, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('8a72ea6a', 'hex'), 'function offers(uint256) view returns (uint256 offerId, address lender, address borrower, address lendToken, uint256 lendAmount, address collateralToken, uint256 collateralAmount, uint256 duration, uint256 startTime, uint256 endTime, uint256 lenderFee, uint8 status)', 'public', 'read'),
    ...
    (16, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('7ffb21b6', 'hex'), 'function userBorrowerOffers(address, uint256) view returns (uint256)', 'public', 'read'),
    (17, decode('5fbdb2315678afecb367f032d93f642f64180aa3', 'hex'), decode('e16abc26', 'hex'), 'function userLenderOffers(address, uint256) view returns (uint256)', 'public', 'read'),
    -- Native Token Vault functions (public read)
    (18, decode('0000000000000000000000000000000000010004', 'hex'), decode('97bb3ce9', 'hex'), 'function tokenAddress(bytes32 assetId) view returns (address)', 'public', 'read'),
    (19, decode('0000000000000000000000000000000000010004', 'hex'), decode('fd3f60df', 'hex'), 'function assetId(address token) view returns (bytes32)', 'public', 'read')
